...
<div class="container">
	<div class="row">
		...
		<form id="contact-form"  enctype="multipart/form-data" role="form" action="/user/contact" method="post">
			<?php if ( \Src\Core\Session::hasFlash() ):?>
				<div class="well well-sm"><strong><i class="glyphicon glyphicon-ok form-control-feedback"></i><?php echo \Src\Core\Session::flash();?></strong></div>
			<?php endif;?>
			<div class="col-lg-6">
