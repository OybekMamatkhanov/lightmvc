...
?>
	...
	<form enctype="multipart/form-data" action="/user/register" method="post" class="form-signin">
		<h1></h1>
		...
		<input type="file" id="inputFile" class="form-control" required="" placeholder="<?=Language::get('file')?>" name="file">
